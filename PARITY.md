...
`Azure.Cosmos.LightEmulator` (the source project this port was ported from) and
the Rust/Axum port (this workspace, now at the repository root). It also
describes the parity **harness** used to verify the port.
