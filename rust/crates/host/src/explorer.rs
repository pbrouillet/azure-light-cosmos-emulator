...
//! `index.html`.
//!
//! The assets are produced by the Vite build (`src/Explorer` → `vite build`,
//! output `src/Host/wwwroot/explorer/`). In debug builds `rust-embed` reads
...
#[derive(RustEmbed)]
#[folder = "../../../src/Host/wwwroot/explorer"]
